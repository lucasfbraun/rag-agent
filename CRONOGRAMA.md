...
**Status:** 🟨 Em andamento (tarefas 1-5/9 concluídas — schema, service, autenticação, autorização e proteção dos endpoints. ✅ Frontend Streamlit com login corrigido — ver "Frontend: tela de login" abaixo)
