...
- **Testes:** 77 novos, com amostras de texto real da coleção de produção; suíte de RAG/MCP em 178/178. **Validação ponta a ponta pendente** — Docker Desktop parado nesta sessão, então não houve execução real contra Qdrant/LLM.
