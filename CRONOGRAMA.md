...
**Status:** 🟨 Em andamento (tarefas 1-6/9 concluídas — schema, service, autenticação, autorização, proteção dos endpoints e restrição de campos sensíveis estruturados. ✅ Frontend Streamlit com login corrigido — ver "Frontend: tela de login" abaixo)
