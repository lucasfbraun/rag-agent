...
| **Relação entre produtos** | "AG 2032, CAT 136 e RG 2464 são utilizados juntos?" | Busca individualmente todos os produtos citados e prioriza referências cruzadas em todas as direções (`rag/engine.py`) |
